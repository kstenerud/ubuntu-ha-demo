...
multipass launch daily:cosmic --cloud-init ./keepalived-cloud-config.yaml --name test-node1
multipass launch daily:cosmic --cloud-init ./keepalived-cloud-config.yaml --name test-node2
